...
class Part {
    ...
    static List<Factory<? extends Part>> factoriesPart = new ArrayList<Factory<? extends Part>>();

    static {
        factoriesPart.add(new FuelFilter.Factory());
        factoriesPart.add(new AirFilter.Factory());
        factoriesPart.add(new CabinAirFilter.Factory());
        factoriesPart.add(new OilFilter.Factory());
        factoriesPart.add(new FanBelt.Factory());
        factoriesPart.add(new GeneratorBelt.Factory());
        factoriesPart.add(new PowerSteeringBelt.Factory());
    }

    private static Random random = new Random(47);
    public static Part createRandom() {
        int n = random.nextInt(factoriesPart.size());
        return factoriesPart.get(n).create();
    }
}
